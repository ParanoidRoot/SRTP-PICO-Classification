...
def create_lstm_model():
    ...
    # # inputs = Input(shape=(TIME_STEPS, (len(pico_elements),INPUT_DIM)))
    # embed= Embedding(num_words,
    #                     output_dim=embedding_dim,
    #                     weights=[embedding_matrix],
    #                     input_length=max_length,
    #                     trainable=False)
    # lstm_out = Bidirectional(LSTM(lstm_units, return_sequences=True), name='bilstm')(embed)
    # attention_mul = attention_3d_block(lstm_out)
    # attention_flatten = Flatten()(attention_mul)
    # # drop2 = Dropout(0.3)(attention_flatten)
    # outputs = Dense(10, activation='sigmoid')(attention_flatten)
    ...
    attention_mul = attention_3d_block(bilstm_layer)
    attention_flatten = Flatten()(attention_mul)
    drop2 = Dropout(0.3)(attention_flatten)
